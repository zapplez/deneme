...
def parse_args():
    ...
    parser.add_argument('--num_encoders', type=int, default=2, help='Number of encoders')
    parser.add_argument('--num_decoders', type=int, default=2, help='Number of decoders')
    parser.add_argument('--client_data_type', type=str, default='RGB', help='Type of data for the client')
